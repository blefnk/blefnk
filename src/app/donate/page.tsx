...
const FAQS: FAQ[] = [
	...
	{
		answer:
			"I do. I look at where it's needed most and make sure it's going to the right places.",
		question: "Who decides where the money goes?",
	},
	{
		answer:
			"Absolutely. If you want to check the numbers, just ask and I'll share the reports.",
		question: "Can I see how the money's being spent?",
	},
	{
		answer:
			"For sure. You can cancel anytime through the platform you used — no hard feelings.",
	...
	{
		answer:
			"Yes. Platforms like PayPal or Ko-Fi let you do that without showing your name.",
		question: "Can I donate anonymously?",
	},
	{
		answer:
			"Most platforms support other currencies. Just check what your platform allows.",
...
function DonationTiers() {
	...
	return (
		<Section className="space-y-6">
			...
			<Heading as="h3">
				I'm still figuring out the exact perks. Honestly, you might get more
				than you see listed here — I love overdelivering.
			</Heading>
			<Heading as="h3">
...
function PageDescription() {
	return (
		<Section className="space-y-6">
			...
			<Heading as="h3">
				Building something this ambitious takes time — and I'm doing most of it
				solo right now. Every donation helps me move faster, bring in
				collaborators, and keep the momentum going.
			</Heading>
...
function UsageDetails() {
	...
	return (
		<Section className="space-y-6">
			...
			<Heading as="h3">
				I don't just stash it away. Every dollar gets invested back into the
				project — from dev work to community tools to infrastructure. Here's the
				breakdown:
			</Heading>
...
function WaysToDonate() {
	return (
		<Section className="space-y-4">
			...
			<Heading as="h3">
				You can donate through any of the platforms below. Got another method in
				mind? I'm all ears.
			</Heading>
		</Section>
	);
